...
@section('content')
    ...
    <div class="py-16 text-primary bg-secondary">
        ...
        <h1 class="text-3xl mx-auto w-3/4 text-primary font-medium mt-16">Advantages of Sea transport</h1>
    </div>

    <div class="py-16 text-primary">
        <h1 class="text-3xl mx-auto w-3/4 text-primary font-medium">We carry these main activities in Sea Freight</h1>
        <div class="w-3/5 mx-auto mt-16 flex flex-col gap-8 items-center">
            <div class="rounded-2xl bg-primary w-full flex">
                ...
                <div class="w-4/5 py-4 pr-8">
                    <div class="px-8 py-4 bg-secondary rounded-r-xl">
                        <h3 class="text-xl font-bold">European and UK dedicated service</h3>
            ...
            <div class="rounded-2xl bg-primary w-full flex">
                ...
                <div class="w-4/5 py-4 pr-8">
                    <div class="px-8 py-4 bg-secondary rounded-r-xl">
                        <h3 class="text-xl font-bold">America and Europe sea freight</h3>
            ...
            <div class="rounded-2xl bg-primary w-full flex">
                ...
                <div class="w-4/5 py-4 pr-8">
                    <div class="px-8 py-4 bg-secondary rounded-r-xl">
                        <h3 class="text-xl font-bold">Vietnam-America ocean freight</h3>
            ...
            <div class="rounded-2xl bg-primary w-full flex">
                ...
                <div class="w-4/5 py-4 pr-8">
                    <div class="px-8 py-4 bg-secondary rounded-r-xl">
                        <h3 class="text-xl font-bold">Yantian/Hong Kong port DG</h3>
            ...
            <div class="rounded-2xl bg-primary w-full flex">
                ...
                <div class="w-4/5 py-4 pr-8">
                    <div class="px-8 py-4 bg-secondary rounded-r-xl">
                        <h3 class="text-xl font-bold">Mexico sea freight</h3>
                        <p class="mt-2 line-clamp-3 min-h-[4.5rem]">Providing container sea export, bulk cargo
