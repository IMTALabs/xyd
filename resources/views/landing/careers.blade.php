...
@section('content')
    <img src="{{ asset('images/covers/Ảnh trang chủ web (trang con)-07.png') }}" class="w-full" alt="">
            ...
            <div class="w-full lg:w-2/3 lg:pr-4 space-y-8">
                <div>
                    ...
                    <div class="bg-secondary flex p-8 pb-0 pt-4 gap-16">
                        ...
                        <div>
                            <h2 class="text-xl font-medium line-clamp-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab
