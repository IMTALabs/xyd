...
@section('content')
    <img src="{{ asset('images/covers/Ảnh trang chủ web (trang con)-13.png') }}" class="w-full" alt="">
    ...
    <div class="max-lg:px-4">
        <div class="py-16 text-primary bg-secondary px-4">
            ...
            <h1 class="text-3xl mx-auto w-full lg:w-3/4 text-primary font-medium mt-16">{{ __('Advantages of Land transport') }}</h1>
        ...
        <div class="py-16 text-primary">
            <h1 class="text-3xl mx-auto w-full lg:w-3/4 text-primary font-medium">{{ __('We carry these main activities in Land Freight') }}</h1>
            <div class="w-full lg:w-3/5 mx-auto mt-16 flex max-lg:flex-col items-center">
                <div class="w-full lg:w-1/2 lg:pr-8 relative -mb-12">
                ...
                <div class="w-full lg:w-1/2 lg:pl-8 text-justify max-lg:mt-4">
