...
@section('content')
    ...
    <div class="max-lg:px-4">
        ...
        <h1 class="text-3xl mx-auto w-full lg:w-3/4 text-primary font-medium">{{ __('Main Business Summary') }}</h1>
        ...
        <div class="bg-secondary py-16 text-primary px-2">
            ...
            <div class="w-full lg:w-3/5 mx-auto mt-12 flex max-lg:flex-col gap-16 justify-center">
                <div class="flex flex-col items-center text-xl gap-2 text-center w-full lg:w-1/5">
        ...
        <div class="py-16 text-primary">
            ...
            <div class="w-full lg:w-3/5 mx-auto mt-12 flex max-lg:flex-col flex-wrap gap-y-16 justify-center">
                <div class="flex justify-center items-center text-xl gap-2 text-center w-full lg:w-1/2">
                ...
                <div class="flex justify-center items-center text-xl gap-2 text-center w-full lg:w-1/2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24">
                        <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                           stroke-width="2">
                            <path
                                d="M2 21c.6.5 1.2 1 2.5 1c2.5 0 2.5-2 5-2c1.3 0 1.9.5 2.5 1c.6.5 1.2 1 2.5 1c2.5 0 2.5-2 5-2c1.3 0 1.9.5 2.5 1"/>
                            <path d="M19.38 20A11.6 11.6 0 0 0 21 14l-9-4l-9 4c0 2.9.94 5.34 2.81 7.76"/>
                            <path d="M19 13V7a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v6m7-3v4m0-12v3"/>
                        </g>
                    </svg>
                    {{ __('Sea Freight') }}
                </div>
