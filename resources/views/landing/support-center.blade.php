...
@section('content')
    ...
    <div class="max-lg:px-4">
        ...
        <h1 class="text-3xl mx-auto w-full lg:w-3/4 text-primary font-medium">{{ __('Support Center') }}</h1>

        <div class="w-full lg:w-3/5 mx-auto pb-16 mt-16 grid grid-cols-2 gap-16 text-primary">
