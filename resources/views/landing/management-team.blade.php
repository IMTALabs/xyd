    ...
    <div class="container mx-auto max-lg:px-4 pb-16 text-primary">
        ...
        <div class="mt-4 flex max-lg:flex-col-reverse">
            <div class="max-lg:mt-4 w-2/3 max-lg:w-full text-justify text-xl lg:pr-8">
                ...
                <div class="mt-4 text-right">Huang Qiaozhong, {{ __('President') }}</div>
            </div>
        ...
        <div class="mt-8 grid gap-8 lg:grid-cols-2">
            <div class="flex gap-4">
                <div class="h-32 w-24 overflow-hidden shrink-0">
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs line-clamp-4">
            ...
            <div class="flex gap-4">
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs line-clamp-4">{{ __('Provide financial planning and analysis, formulate risk management and control strategies, manage taxes, and supervise group finances.') }}</p>
                </div>
            </div>
            <div class="flex gap-4">
                <div class="h-32 w-24 overflow-hidden shrink-0">
            ...
            <div class="flex gap-4">
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs line-clamp-4">{{ __('Develop and manage operating budgets to ensure appropriate allocation of resources, analyze operational data to evaluate performance, identify trends and make decisions, and ensure collaboration and communication among various teams.') }}</p>
                </div>
            </div>
            <div class="flex gap-4">
                <div class="h-32 w-24 overflow-hidden shrink-0">
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs line-clamp-4">{{ __('Develop sales strategies, research markets, expand customer base, recruit, train and lead sales team members, collect and analyze customer feedback to improve products or services.') }}</p>
                </div>
            </div>
            <div class="flex gap-4">
                <div class="h-32 w-24 overflow-hidden shrink-0">
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs line-clamp-4">{{ __('Develop sales strategies, develop markets, expand customer base, recruit, train and lead sales team members, collect and analyze customer feedback to improve products or services.') }}</p>
                </div>
            </div>
        </div>
