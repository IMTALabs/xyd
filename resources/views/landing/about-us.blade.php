...
@section('content')
    <img src="https://placehold.co/1600x320" class="object-cover w-full" alt="">
    ...
    <div class="py-16 text-primary">
        <ul class="w-3/4 mx-auto flex items-center">
            ...
            <a href="#">About Xiangyuda Express</a>
        </ul>

        <div class="w-3/5 mx-auto mt-8 flex pb-16">
            <img src="https://placehold.co/600x400" alt="" class="w-1/2">
            <div class="w-1/2 pl-8">
                ...
                <p class="mt-2 text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab accusantium ad,
                    aspernatur cumque
                    deleniti dicta doloribus eaque, est excepturi hic ipsam ipsum, itaque modi numquam odio perspiciatis
        ...
        <div>
            ...
            <div class="w-3/4 bg-secondary mx-auto -translate-y-24 px-32 py-16">
        ...
        <div class="w-3/5 mx-auto flex pb-16">
            <img src="https://placehold.co/600x400" alt="" class="w-1/2">
            <div class="w-1/2 pl-8">
        ...
        <div class="bg-secondary px-32 py-16">
            <h2 class="text-3xl font-medium text-center">Core value</h2>
            <p class="text-center mt-8 w-3/5 mx-auto">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Accusamus, aut autem!
                Alias amet,
                architecto, dolore, harum omnis perferendis quisquam saepe sequi unde voluptate voluptatem
                voluptates! Enim illum omnis quasi repudiandae.</p>
            ...
            <div
                class="flex mx-auto mt-16 w-3/5 border-y-2 border-solid border-black divide-x-2 divide-black font-semibold">
            ...
            <div class="w-3/4 flex justify-between mx-auto mt-16">
        ...
        <div class=" py-16">
            ...
            <p class="text-center mt-8 w-3/5 mx-auto">The reason why you should choose us to be your transportation
                partner</p>

            <div class="w-3/4 grid grid-cols-2 mx-auto mt-16 gap-8">
                ...
                <div class="col-span-1 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24"><path fill="currentColor" d="M10.5 15.5h3V13H16v-3h-2.5V7.5h-3V10H8v3h2.5v2.5ZM12 22q-3.475-.875-5.738-3.988T4 11.1V5l8-3l8 3v6.1q0 3.8-2.263 6.913T12 22Zm0-2.1q2.6-.825 4.3-3.3t1.7-5.5V6.375l-6-2.25l-6 2.25V11.1q0 3.025 1.7 5.5t4.3 3.3Zm0-7.9Z"/></svg>
                    <div class="ml-4">
