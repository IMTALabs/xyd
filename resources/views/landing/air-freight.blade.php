...
@section('content')
    ...
    <div class="py-16 text-primary bg-secondary">
        ...
        <h1 class="text-3xl mx-auto w-3/4 text-primary font-medium mt-16">Advantages of Air transport</h1>
    </div>

    <div class="py-16 text-primary">
        <h1 class="text-3xl mx-auto w-3/4 text-primary font-medium">We carry these main activities in Air Freight</h1>
    </div>
