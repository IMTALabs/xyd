...
@section('content')
    ...
    <div class="py-16 text-primary">
        <ul class="w-3/4 mx-auto flex items-center">
            ...
            <a href="#">Supply chain solution</a>
        </ul>
    </div>

    <h1 class="text-3xl mx-auto w-3/4 text-primary font-medium">Supply chain solution</h1>
    ...
    <div class="w-3/4 mx-auto pb-16 text-primary grid grid-cols-2 gap-16">
        <div class="relative col-span-1">
            ...
            <a href="#" class="text-secondary bg-primary block px-4 py-1 absolute bottom-4 right-0">Read more</a>
        </div>
        ...
        <div class="relative col-span-1">
            <div class="flex items-center gap-4">
                <div class="h-0.5 grow bg-primary"></div>
                <div class="text-3xl font-bold">Land Freight</div>
                <div class="h-0.5 grow bg-primary"></div>
            </div>
            <img src="https://placehold.co/640x200" class="mt-4 object-cover w-full" alt="">
            <a href="#" class="text-secondary bg-primary block px-4 py-1 absolute bottom-4 right-0">Read more</a>
        ...
        <div class="relative col-span-1">
            <div class="flex items-center gap-4">
                <div class="h-0.5 grow bg-primary"></div>
                <div class="text-3xl font-bold">Warehouse</div>
                <div class="h-0.5 grow bg-primary"></div>
            </div>
            <img src="https://placehold.co/640x200" class="mt-4 object-cover w-full" alt="">
            <a href="#" class="text-secondary bg-primary block px-4 py-1 absolute bottom-4 right-0">Read more</a>
    ...
    <div class="w-3/4 mx-auto pb-16 text-primary">
