...
@section('content')
    ...
    <div class="max-lg:px-4">
        ...
        <h1 class="text-3xl mx-auto w-full lg:w-3/4 text-primary font-medium">{{ __('A to Z Transportation Service') }}</h1>
        ...
        <div class="mx-auto w-full lg:w-3/4 text-primary pb-16">
            ...
            <div class="flex max-lg:flex-col items-center mt-16">
                <div class="w-full lg:w-1/2 lg:pr-8 text-justify">
                ...
                <div class="w-full lg:w-1/2 lg:pl-8 grid lg:grid-cols-2 gap-x-16 gap-y-8 max-lg:mt-4">
                    <div class="flex items-center text-xl gap-4 col-span-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="shrink-0" width="64" height="64" viewBox="0 0 256 256">
                            <path fill="currentColor"
            ...
            <div class="flex max-lg:flex-col items-center mt-16">
                ...
                <div class="w-full lg:w-1/2 lg:pl-8 grid lg:grid-cols-2 gap-x-16 gap-y-8 max-lg:mt-4">
                    <div class="flex lg:flex-col items-center text-xl gap-4 col-span-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="shrink-0" width="64" height="64" viewBox="0 0 256 256"><path fill="currentColor" d="M184 24H72a32 32 0 0 0-32 32v128a32 32 0 0 0 32 32h8l-14.4 19.2a8 8 0 1 0 12.8 9.6L100 216h56l21.6 28.8a8 8 0 1 0 12.8-9.6L176 216h8a32 32 0 0 0 32-32V56a32 32 0 0 0-32-32ZM56 120V80h64v40Zm80-40h64v40h-64ZM72 40h112a16 16 0 0 1 16 16v8H56v-8a16 16 0 0 1 16-16Zm112 160H72a16 16 0 0 1-16-16v-48h144v48a16 16 0 0 1-16 16Zm-88-28a12 12 0 1 1-12-12a12 12 0 0 1 12 12Zm88 0a12 12 0 1 1-12-12a12 12 0 0 1 12 12Z"/></svg>
