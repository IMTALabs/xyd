...
@section('content')
    <img src="{{ asset('images/covers/Ảnh trang chủ web (trang con)-14.png') }}" class="w-full" alt="">
    ...
    <div class="py-16 text-primary bg-secondary px-4">
        ...
        <h1 class="text-3xl mx-auto w-full lg:w-3/4 text-primary font-medium mt-16">{{ __('Advantages of Sea transport') }}</h1>
        ...
        <div class="w-full lg:w-3/4 mx-auto mt-16 grid lg:grid-cols-3 gap-16">
            <div class="border-primary border flex flex-col items-end rounded">
                <div class="text-center font-bold border-l-2 border-b-2 border-primary px-4 py-2">{{ __('President\'s Message') }}</div>
    ...
    <div class="max-lg:px-4">
        <div class="py-16 text-primary">
            <h1 class="text-3xl mx-auto w-full lg:w-3/4 text-primary font-medium">{{ __('We carry these main activities in Sea Freight') }}</h1>
            <div class="w-full lg:w-3/5 mx-auto mt-16 flex flex-col gap-8 items-center">
                <div class="rounded-2xl bg-primary w-full flex">
                    ...
                    <div class="w-full lg:w-4/5 py-4 pr-8">
                        <div class="px-8 py-4 bg-secondary rounded-r-xl">
                            ...
                            <p class="mt-2 line-clamp-3 min-h-[4.5rem]">Customers can choose between two types of
                                transactions: customs clearance and
                                taxes
                                included, or VAT tax. We offer various transportation options such as air freight and
                                sea-rail intermodal transport to meet the different time requirements of our customers.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-2xl bg-primary w-full flex">
                    ...
                    <div class="w-full lg:w-4/5 py-4 pr-8">
                        <div class="px-8 py-4 bg-secondary rounded-r-xl">
                            ...
                            <p class="mt-2 line-clamp-3 min-h-[4.5rem]">Providing container sea export, bulk cargo
                                transportation, bulk cargo
                                consolidation, sea, land, multimodal transport and customs clearance services, with
                ...
                <div class="rounded-2xl bg-primary w-full flex">
                    ...
                    <div class="w-full lg:w-4/5 py-4 pr-8">
                        <div class="px-8 py-4 bg-secondary rounded-r-xl">
                            ...
                            <p class="mt-2 line-clamp-3 min-h-[4.5rem]">Air and ocean freight from Vietnam to America,
                                covering DDP, the first leg,
                                clearance,
                                pick-up and delivery.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-2xl bg-primary w-full flex">
                    ...
                    <div class="w-full lg:w-4/5 py-4 pr-8">
                        <div class="px-8 py-4 bg-secondary rounded-r-xl">
                            ...
                            <p class="mt-2 line-clamp-3 min-h-[4.5rem]">Regular declaration of export of Class 9 dangerous
                                goods, with its own DG
                                warehouse, mature
                                operation experience for many years, perfect customs clearance services at home and
                                abroad, stable timeliness, always leading the industry.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-2xl bg-primary w-full flex">
                    ...
                    <div class="w-full lg:w-4/5 py-4 pr-8">
                        <div class="px-8 py-4 bg-secondary rounded-r-xl">
                            ...
                            <p class="mt-2 line-clamp-3 min-h-[4.5rem]">Providing container sea export, bulk cargo
                                consolidation, and full container
                                transportation
                                services, with double clearance and tax included direct to Mexico City. Provide insurance
                                services, with fixed container loading every week and stable timeliness.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full lg:w-3/5 mx-auto mt-16 flex max-lg:flex-col items-center gap-8">
                <div class="grow">
                    ...
                    <div class="bg-secondary p-4 relative">
                        <h3 class="font-semibold text-xl">{{ __('Air Freight') }}</h3>
                        <a href="{{ route('air-freight') }}" class="block bg-primary text-secondary px-4 py-1 top-0 -translate-y-1/2 absolute right-0">{{ __('Read more') }}</a>
                    </div>
                </div>
                <div class="grow">
                    <img src="https://placehold.co/240x320" class="w-full object-cover" alt="">
                    <div class="bg-secondary p-4 relative">
                        <h3 class="font-semibold text-xl">{{ __('Land Freight') }}</h3>
                        <a href="{{ route('land-freight') }}" class="block bg-primary text-secondary px-4 py-1 top-0 -translate-y-1/2 absolute right-0">{{ __('Read more') }}</a>
                    </div>
                </div>
                <div class="grow">
                    <img src="https://placehold.co/240x320" class="w-full object-cover" alt="">
                    <div class="bg-secondary p-4 relative">
                        <h3 class="font-semibold text-xl">{{ __('Sea Freight') }}</h3>
                        <a href="{{ route('sea-freight') }}" class="block bg-primary text-secondary px-4 py-1 top-0 -translate-y-1/2 absolute right-0">{{ __('Read more') }}</a>
                    </div>
                </div>
            </div>
        </div>
