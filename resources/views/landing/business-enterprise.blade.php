...
@section('content')
    ...
    <div class="max-lg:px-4">
        ...
        <h1 class="text-3xl mx-auto w-full lg:w-3/4 text-primary font-medium">{{ __('Business Enterprise') }}</h1>
        ...
        <div class="flex flex-col gap-8 w-full lg:w-3/5 mx-auto pb-16">
