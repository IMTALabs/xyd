...
@section('content')
    ...
    <h1 class="text-3xl mx-auto w-3/4 text-primary font-medium">Bring the best quality ...</h1>
    <div class="mx-auto w-3/5 text-justify text-primary pb-16 mt-12">
    ...
    <h2 class="text-3xl mx-auto w-3/4 text-primary">We have prove of our success</h2>
    <div class="flex w-3/4 mx-auto">
        <div class="mb-4 border-l-2 py-8 border-primary text-primary w-2/3 mt-4 shrink-0">
            <div class="flex items-center gap-4 text-xl font-medium">
                <div class="w-5 h-5 bg-primary rounded-full -translate-x-2.5"></div>
        ...
        <img src="https://placehold.co/453x632" class="w-1/3 object-cover my-4" alt="">
    </div>
@endsection
