    ...
    <div class="relative hidden lg:block">
        <ul class="flex items-center gap-8 text-sm">
            <li @mouseenter="toggle('about')" @mouseleave="toggle('about')">
                <a class="flex items-center font-semibold text-white" href="#">{{ __('About us') }}
                ...
                <div class="absolute top-5 left-0 flex shadow-xl text-primary w-[120%] border-t-[1rem] border-primary"
                     x-transition
                     x-show="current === 'about'">
                    <div class="bg-[#f6f0b4] font-semibold text-xl flex items-center px-8">{{ __('About us') }}</div>
                    <div class="grid grow grid-cols-2 gap-y-4 bg-white px-8 py-4 text-sm">
                        ...
                        <div class="col-span-1"><a href="{{ route('management-team') }}">{{ __('Management Team') }}</a>
                        </div>
                        <div class="col-span-1"><a
                                href="{{ route('long-term-vision') }}">{{ __('Long-term Vision') }}</a></div>
                        <div class="col-span-1"><a href="{{ route('our-quality') }}">{{ __('Our Quality') }}</a></div>
                        <div class="col-span-1"><a
            ...
            <li @mouseenter="toggle('services')" @mouseleave="toggle('services')">
                <a class="flex items-center font-semibold text-white" href="#">{{ __('Our service') }}
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                ...
                <div class="absolute top-5 left-0 flex shadow-xl text-primary w-[120%] border-t-[1rem] border-primary"
                    ...
                    <div class="bg-[#f6f0b4] font-semibold text-xl flex items-center px-8">{{ __('Our service') }}</div>
                    <div class="grid grow grid-cols-2 gap-y-4 bg-white px-8 py-4 text-sm">
                        <div class="col-span-1"><a
            ...
            <li @mouseenter="toggle('channels')" @mouseleave="toggle('channels')">
                <a class="flex items-center font-semibold text-white" href="#">{{ __('Main channels') }}
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                ...
                <div class="absolute top-5 left-0 flex shadow-xl text-primary w-[120%] border-t-[1rem] border-primary"
                    ...
                    <div class="grid grow grid-cols-2 gap-y-4 bg-white px-8 py-4 text-sm">
                        <div class="col-span-1"><a href="{{ route('land-freight') }}">{{ __('Land Freight') }}</a></div>
                        <div class="col-span-1"><a href="{{ route('sea-freight') }}">{{ __('Sea Freight') }}</a></div>
                        <div class="col-span-1"><a href="{{ route('air-freight') }}">{{ __('Air Freight') }}</a></div>
                        <div class="col-span-1"><a
            ...
            <li @mouseenter="toggle('help')" @mouseleave="toggle('help')">
                <a class="flex items-center font-semibold text-white" href="#">{{ __('Help center') }}
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                ...
                <div class="absolute top-5 left-0 flex shadow-xl text-primary w-[120%] border-t-[1rem] border-primary"
                     x-transition
                     x-show="current === 'help'">
                    <div class="bg-[#f6f0b4] font-semibold text-xl flex items-center px-8">{{ __('Help center') }}</div>
                    <div class="grid grow grid-cols-2 gap-y-4 bg-white px-8 py-4 text-sm">
                        <div class="col-span-1"><a href="{{ route('support-center') }}">{{ __('Support center') }}</a>
                        </div>
            ...
            <li @mouseenter="toggle('news')" @mouseleave="toggle('news')">
                <a class="flex items-center font-semibold text-white" href="#">{{ __('Insight & News') }}
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                ...
                <div class="absolute top-5 left-0 flex shadow-xl text-primary w-[120%] border-t-[1rem] border-primary"
                    ...
                    <div class="grid grow grid-cols-2 gap-y-4 bg-white px-8 py-4 text-sm">
                        <div class="col-span-1"><a href="{{ route('company-news') }}">{{ __('Company News') }}</a></div>
...
<main>
    ...
    <div
        ...
        <div class="relative w-full lg:w-1/2 lg:max-w-2xl">
            <input type="text"
...
<footer class="grid grid-cols-4 gap-8 pt-8 bg-primary">
    ...
    <div class="col-span-full px-2 text-sm text-secondary lg:col-span-1">
        ...
        <a class="mt-3 block">{{ __('Frequently asked questions') }}</a>
        <a class="mt-2 block">{{ __('Terms & Policy') }}</a>
        <a class="mt-2 block">{{ __('Customer Feedback') }}</a>
    </div>
    <div class="col-span-full px-2 text-secondary lg:col-span-1">
        <h3 class="text-2xl font-semibold">{{ __('Connect with us') }}</h3>
        <div class="mt-3 flex gap-4">
            <a class="h-8 w-8">
                <img width="32" height="32" src="https://img.icons8.com/fluency/48/facebook.png" alt="facebook"/>
            </a>
            <a class="h-8 w-8">
                <img width="32" height="32" src="https://img.icons8.com/fluency/48/tiktok.png" alt="tiktok"/>
            </a>
            <a class="h-8 w-8">
            ...
            <a class="h-8 w-8">
                <img width="25" height="25"
                     src="https://img.icons8.com/external-tal-revivo-shadow-tal-revivo/48/external-wechat-worlds-largest-standalone-mobile-apps-by-monthly-active-users-logo-shadow-tal-revivo.png"
                     alt="external-wechat-worlds-largest-standalone-mobile-apps-by-monthly-active-users-logo-shadow-tal-revivo"/>
            </a>
        </div>
    </div>
